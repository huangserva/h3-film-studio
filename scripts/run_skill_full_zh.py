...
SHOTS = {
    ...
    "S6": {
        "prompt": (
            f"{ROOM}{MAN_ID}。{WOMAN_ID}。"
            f"两人已全身赤裸（男仅网巾短须）。他拥她坐到床上，她坐靠在他身前，"
            f"他从侧后亲吻她额发与颈侧，她闭眼不看镜头。"
            f"略侧半身，烛光偏暗。仅两位成年人类，无动物。无对白。"
        ),
    ...
    "S7": {
        "prompt": (
            f"{ROOM}{MAN_ID}。{WOMAN_ID}。"
            f"保持首帧人物与房间一致。她跨坐在他身上开始起伏交合，面对面，"
            f"低头看他或闭眼，绝不看镜头。他坐或半躺抓她腰，网巾仍在。"
            f"略侧半身暗光。仅两位成年人类，无动物。镜头稳定。"
        ),
    ...
    "S8": {
        "prompt": (
            f"{ROOM}{MAN_ID}。{WOMAN_ID}。"
            f"同一床上正常位交合加快，全身赤裸，男网巾短须锁死。"
            f"有力节奏抽送，身体随动作晃动，她抓紧床单。略侧半身暗光，不看镜头。"
            f"仅两位成年人类，无动物。"
        ),
    ...
    "S9": {
        "prompt": (
            f"{ROOM}{MAN_ID}。{WOMAN_ID}。"
            f"女上位进行中：她面对面跨坐在他身上正在上下起伏，低头看他或闭眼，绝不看镜头。"
            f"他仰卧抓她腰，黑色网巾仍在。侧面略低半身，床单凌乱。"
            f"仅两位成年人类，无动物。"
        ),
    ...
    "S10": {
        "prompt": (
            f"{ROOM}{MAN_ID}。{WOMAN_ID}。"
            f"后入式进行中：她双手撑床单跪伏，他在身后抓腰前后抽送，"
            f"她侧脸贴枕喘息不看镜头。略侧半身暗光。男戴网巾留短须。"
            f"画面中只有这两位成年人类，严禁任何动物。"
        ),
    ...
    "S11": {
        "prompt": (
            f"{ROOM}{MAN_ID}。{WOMAN_ID}。"
            f"后入式高潮：抽送加快后余势渐缓，她跪伏他在后，全身赤裸，男网巾短须锁死。"
            f"不看镜头。仅两位成年人类，严禁任何动物。"
        ),
